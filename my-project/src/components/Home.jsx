      ...
      <main className="overflow-scroll bg-[url('src/images/backgrounds/home-light-small.png')] md:bg-[url('src/images/backgrounds/home-light-large.png')] bg-cover bg-center h-screen p-8 md:p-12 lg:p-20">
        <header className="flex justify-between">
          ...
          <div className=" flex items-center">
            <div className="bg-neutral-800 text-white px-4 py-2 md:px-6  md:text-xl font-medium rounded-full">
              Resume
            </div>
            <div className="p-2 ml-3 px-4 text-white md:px-6 md:text-xl bg-neutral-800 rounded-full">
              <Mode />
            </div>
          </div>
        </header>
